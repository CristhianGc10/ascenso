...
export type GeneralEnunciadoOverlay_8_10_Props = {
    isEnabled: boolean;
    triggerLabel?: string;
};

const TITLE = 'Lea la siguiente situación y responda las preguntas 8, 9 y 10.';

export default function GeneralEnunciadoOverlay_8_10({
    isEnabled,
    triggerLabel = 'Mostrar enunciado',
}: GeneralEnunciadoOverlay_8_10_Props) {
    ...
    const content = useMemo(() => {
        return (
            <div style={{ display: 'grid', gap: 12 }}>
                ...
                >
                    {`Los estudiantes de quinto grado visitaron un albergue para animales. Luego de dicha visita, organizados en equipos y con orientación de la docente, los estudiantes acuerdan escribir cartas a representantes de diversas instituciones con el fin de solicitar donaciones para el albergue.`}
                </div>
            </div>
        );
    }, []);
